...
namespace FinanceManager.App.Base
{
    public partial class CadastroBase : MaterialForm
    {
        ...
        {
            if (MessageBox.Show(@"Deseja realmente cancelar?", @"Finance Manager", MessageBoxButtons.YesNo,
        ...
        private void btnExcluir_Click(object sender, EventArgs e)
        {
            ...
            {
                if (MessageBox.Show(@"Deseja realmente deletar?", @"Finance Manager", MessageBoxButtons.YesNo,
                        MessageBoxIcon.Question)
                    == DialogResult.Yes)
                {
            ...
            {
                MessageBox.Show(@"Selecione algum registro!", @"Finance Manager", MessageBoxButtons.OK,
